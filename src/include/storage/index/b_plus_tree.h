...
class BPlusTree {
 ...
 public:
  ...
  Page *READ_FindLeafPage(const KeyType &key, bool leftMost = false, Transaction *transaction);
  Page *WRITE_FindLeafPage(const KeyType &key, bool leftMost = false, Transaction *transaction);
